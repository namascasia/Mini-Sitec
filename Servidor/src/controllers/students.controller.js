...
import { ACTIVE_STUDENT, DELETED_STUDENT } from "../utils/constants/students.constants.js";
    ...
    async getStudents(req = request, res = response) {
        try {
            ...
            const students = await db.select()
                ...
                .where(eq(schemas.students.status, ACTIVE_STUDENT));
        ...
        try {
            const [student] = await db.select()
                ...
                .where(and(
                    ...
                    eq(schemas.students.status, ACTIVE_STUDENT)
                ));
