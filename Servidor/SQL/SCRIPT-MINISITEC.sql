...
ALTER TABLE CARGAS
ADD CONSTRAINT FK_CARGA_GRUPO FOREIGN KEY (CLAVEGRUPO) REFERENCES GRUPOS (CLAVEGRUPO),
ADD CONSTRAINT FK_CARGA_ALUMNOS FOREIGN KEY (NCONTROL) REFERENCES ALUMNOS(NCONTROL),
ADD CONSTRAINT FK_CARGA_MATERIAS FOREIGN KEY (CLAVEMATERIA) REFERENCES MATERIAS(CLAVEMATERIA);
